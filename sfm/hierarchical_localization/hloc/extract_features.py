...
from .filter_key_points import filter_candidate_dynamic_points
...
def main(
    ...
    device: str = "cpu",
    img_seg_infos: Optional[Dict] = None,
) -> Path:
    logger.info(
    ...
    for idx, data in enumerate(tqdm(loader)):
        ...
        filter_candidate_dynamic_points(img_seg_infos, name.split('/')[-1].replace('.jpg', '.npy'), pred)
